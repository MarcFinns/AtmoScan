...
// WARNING - this was used during development and can be used to debug the portions of the sketch that run BEFORE TCP/IP connection is available, but can't be used in the fully assembled system (as serial port is used for a sensor)
#define DEBUG_SERIAL
