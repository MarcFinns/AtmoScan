  ...
  if (config.connected)
  {
    ...
    switch (step)
    {
...
#ifdef DEBUG_SYSLOG
            syslog.log(LOG_INFO, "Geolocation STEP 1 successful");
#endif
          }
          else
          {
...
#ifdef DEBUG_SYSLOG
            syslog.log(LOG_INFO, "Geolocation STEP 2 successful");
#endif
          }
          else
          {
      ...
      case 3:
        {
#ifdef DEBUG_SYSLOG
          syslog.log(LOG_INFO, "Geolocation Step 3 - Acquiring locality...");
#endif
          Geocode geocode;
...
#ifdef DEBUG_SYSLOG
            syslog.log(LOG_INFO, "Geolocation STEP 3 successful");
#endif
          }
          else
          {
    ...
    if (step == 4)
    {
      // All went well...
#ifdef DEBUG_SYSLOG
      syslog.log(LOG_INFO, "Geolocation 4 - enabling NTP sync...");
#endif
...
#ifdef DEBUG_SYSLOG
    syslog.log(LOG_INFO, "Geolocation NOT Valid");
#endif
  }
